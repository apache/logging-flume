...
class LogFileV2 extends LogFile {
    ...
    static class Writer extends LogFile.Writer {
        ...
        Writer(File file, int logFileID, long maxFileSize, long usableSpaceRefreshInterval) throws IOException {
            super(file, logFileID, maxFileSize, null, usableSpaceRefreshInterval, true, 0);
            RandomAccessFile writeFileHandle = getFileHandle();
    ...
    static class SequentialReader extends LogFile.SequentialReader {
        ...
        LogRecord doNext(int offset) throws IOException {
            TransactionEventRecord event = TransactionEventRecord.fromDataInputV2(getFileHandle());
