...
class ReplayHandler {
    ...
    ReplayHandler(FlumeEventQueue queue, @Nullable KeyProvider encryptionKeyProvider, boolean fsyncPerTransaction) {
        this.queue = queue;
            ...
            for (File log : logs) {
                ...
                try {
                    ...
                    Preconditions.checkState(
                            !readers.containsKey(reader.getLogFileID()),
                            "Readers " + readers + " already contains " + reader.getLogFileID());
