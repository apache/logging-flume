...
public class TestUtils {
    ...
    public static FlumeEvent newPersistableEvent() {
        ...
        FlumeEvent event = new FlumeEvent(headers, timestamp.getBytes());
        return event;
    }
    ...
    public static void doForcedCheckpoint(FileChannel channel) {
        ...
        Assert.assertTrue(
                "writeCheckpoint returned false",
    ...
    public static Set<String> takeEvents(Channel channel, int batchSize, int numEvents, boolean checkForCorruption)
            throws Exception {
    ...
    public static Set<String> consumeChannel(Channel channel, boolean checkForCorruption) throws Exception {
        Set<String> result = Sets.newHashSet();
        int[] batchSizes = new int[] {1000, 100, 10, 1};
    ...
    public static Set<String> putEvents(
    ...
    public static Context createFileChannelContext(
            String checkpointDir, String dataDir, String backupDir, Map<String, String> overrides) {
    ...
    public static FileChannel createFileChannel(
            String checkpointDir, String dataDir, String backupDir, Map<String, String> overrides) {
