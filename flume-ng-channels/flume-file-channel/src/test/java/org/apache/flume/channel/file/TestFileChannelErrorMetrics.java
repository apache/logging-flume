...
public class TestFileChannelErrorMetrics extends TestFileChannelBase {
    ...
    public void testCorruptEventTaken() throws Exception {
        FileChannel channel =
                createFileChannel(Collections.singletonMap(FileChannelConfiguration.FSYNC_PER_TXN, "false"));
        channel.start();
    ...
    public void testCheckpointWriteErrorCount() throws Exception {
        ...
        assertEventuallyTrue(
                "checkpointWriterErrorCount should be 1",
                new BooleanPredicate() {
                    @Override
                    public boolean get() {
    ...
    public void testCheckpointBackupWriteErrorShouldIncreaseCounter() throws IOException, InterruptedException {
        ...
        EventQueueBackingStoreFileV3 backingStoreFileV3 =
                new EventQueueBackingStoreFileV3(checkpointFile, 1, "test", fileChannelCounter, backupDir, true, false);
        ...
        assertEventuallyTrue(
                "checkpoint backup write failure should increase counter to 1",
                new BooleanPredicate() {
                    @Override
                    public boolean get() {
    ...
    public void testCheckpointBackupWriteErrorShouldIncreaseCounter2() throws Exception {
        ...
        // first checkpoint should be written successfully -> the counter should remain 0
        assertEventuallyTrue(
                "checkpoint backup should have been written",
                new BooleanPredicate() {
                    @Override
                    public boolean get() {
        ...
        assertEventuallyTrue(
                "checkpointBackupWriteErrorCount should be 1",
                new BooleanPredicate() {
                    @Override
                    public boolean get() {
    ...
    private static void assertEventuallyTrue(String description, BooleanPredicate expression, long timeoutMillis)
