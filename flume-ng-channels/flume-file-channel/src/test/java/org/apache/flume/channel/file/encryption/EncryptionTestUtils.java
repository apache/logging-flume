...
public class EncryptionTestUtils {
    ...
    public static void createKeyStore(File keyStoreFile, File keyStorePasswordFile, Map<String, File> keyAliasPassword)
            throws Exception {
        ...
        char[] keyStorePassword =
                Files.toString(keyStorePasswordFile, Charsets.UTF_8).toCharArray();
    ...
    public static Map<String, String> configureForKeyStore(
            File keyStoreFile, File keyStorePasswordFile, Map<String, File> keyAliasPassword) throws Exception {
        ...
        for (String alias : keyAliasPassword.keySet()) {
            ...
            if (passwordFile == null) {
                ...
                String propertyName = joiner.join(
        ...
        context.put(
                joiner.join(EncryptionConfiguration.KEY_PROVIDER, EncryptionConfiguration.JCE_FILE_KEYS),
                Joiner.on(" ").join(keys));
        return context;
    }
}
