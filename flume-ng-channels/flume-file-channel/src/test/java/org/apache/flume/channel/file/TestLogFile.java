...
public class TestLogFile {
    ...
    public void setup() throws IOException {
        ...
        logFileWriter = LogFileFactory.getWriter(
                dataFile, fileID, Integer.MAX_VALUE, null, null, null, Long.MAX_VALUE, true, 0);
    }
            ...
            completionService.submit(new Callable<Void>() {
                ...
                public Void call() {
                    try {
                        ...
                        writer.put(bytes);
                        writer.commit(
                                TransactionEventRecord.toByteBuffer(new Commit(txnId.get(), WriteOrderOracle.next())));
                        barrier.await();
                        writer.sync();
                    } catch (Exception ex) {
