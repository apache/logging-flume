...
public class PollableSourceRunner extends SourceRunner {
    ...
    public void start() {
        ...
        runnerThread.setName(
                getClass().getSimpleName() + "-" + source.getClass().getSimpleName() + "-" + source.getName());
        runnerThread.start();
        ...
        public void run() {
            ...
            while (!shouldStop.get()) {
                ...
                try {
                    ...
                    logger.error(
                            "Unhandled exception, logging and sleeping for " + source.getMaxBackOffSleepInterval()
                                    + "ms",
                            e);
                    try {
