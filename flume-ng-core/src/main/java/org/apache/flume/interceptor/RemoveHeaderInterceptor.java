...
public class RemoveHeaderInterceptor implements Interceptor {
     ...
     */
    private RemoveHeaderInterceptor(
            final String withName, final String fromList, final String listSeparator, final Pattern matchRegex) {
        this.withName = withName;
        assert listSeparator != null : "Default value used otherwise";
        this.fromList = (fromList != null) ? new HashSet<>(Arrays.asList(fromList.split(listSeparator))) : null;
    ...
    public static class Builder implements Interceptor.Builder {
        ...
        public Interceptor build() {
            ...
            return new RemoveHeaderInterceptor(withName, fromList, listSeparator, matchRegex);
        }
        ...
        public void configure(final Context context) {
            ...
            listSeparator = context.getString(LIST_SEPARATOR, LIST_SEPARATOR_DEFAULT);
