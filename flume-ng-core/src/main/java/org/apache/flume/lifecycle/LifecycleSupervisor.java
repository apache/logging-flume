...
public class LifecycleSupervisor implements LifecycleAware {
    ...
    public LifecycleSupervisor() {
        ...
        monitorService = new ScheduledThreadPoolExecutor(
                10,
    ...
    public synchronized void supervise(
            LifecycleAware lifecycleAware, SupervisorPolicy policy, LifecycleState desiredState) {
        ...
        Preconditions.checkState(
                !supervisedProcesses.containsKey(lifecycleAware),
                "Refusing to supervise " + lifecycleAware + " more than once");

        if (logger.isDebugEnabled()) {
            logger.debug(
                    "Supervising service:{} policy:{} desiredState:{}",
            ...
            try {
                ...
                synchronized (lifecycleAware) {
                    ...
                    if (!lifecycleAware.getLifecycleState().equals(supervisoree.status.desiredState)) {
                        ...
                        logger.debug("Want to transition {} from {} to {} (failures:{})", new Object[] {
                            lifecycleAware,
                        ...
                        switch (supervisoree.status.desiredState) {
                            ...
                            default:
                                logger.warn(
                                        "I refuse to acknowledge {} as a desired state",
                                        supervisoree.status.desiredState);
                        }
