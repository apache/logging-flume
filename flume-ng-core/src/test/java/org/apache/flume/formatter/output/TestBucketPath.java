...
public class TestBucketPath {
    ...
    public void testDateFormatMinutesTimeZone() {
        ...
        String escapedString =
                BucketPath.escapeString(test, headersWithTimeZone, CUSTOM_TIMEZONE, true, Calendar.MINUTE, 5, false);
        System.out.println("Escaped String: " + escapedString);
    ...
    public void testDateFormatSecondsTimeZone() {
        String test = "%s";
        String escapedString =
                BucketPath.escapeString(test, headersWithTimeZone, CUSTOM_TIMEZONE, true, Calendar.SECOND, 5, false);
        System.out.println("Escaped String: " + escapedString);
    ...
    public void testDateRace() {
        ...
        long two = ZonedDateTime.parse("2013-04-21T02:59:59-00:00", ISO_DATE_TIME)
                .toInstant()
                .toEpochMilli();
        long three = ZonedDateTime.parse("2013-04-21T03:00:00-00:00", ISO_DATE_TIME)
                .toInstant()
                .toEpochMilli();
        ...
        String pat = "%H:%M";
        String escaped = BucketPath.escapeString(
                pat, new HashMap<String, String>(), TimeZone.getTimeZone("UTC"), true, Calendar.MINUTE, 10, true);
    ...
    private static Calendar createCalendar(
            int year, int month, int day, int hour, int minute, int second, int ms, @Nullable TimeZone timeZone) {
    ...
    public void testStaticEscapeStrings() {
        ...
        String realPath =
                BucketPath.escapeString(filePath, headers, utcTimeZone, false, Calendar.HOUR_OF_DAY, 12, false);
