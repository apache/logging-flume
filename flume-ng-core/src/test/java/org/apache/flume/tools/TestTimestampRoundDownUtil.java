...
public class TestTimestampRoundDownUtil {
    ...
    public void testRoundDownTimeStampSecondsWithTimeZone() {
        ...
        long withTimeZone =
                TimestampRoundDownUtil.roundDownTimeStampSeconds(cal.getTimeInMillis(), 60, CUSTOM_TIMEZONE);
    ...
    public void testRoundDownTimeStampMinutesWithTimeZone() {
        ...
        long withTimeZone = TimestampRoundDownUtil.roundDownTimeStampMinutes(cal.getTimeInMillis(), 5, CUSTOM_TIMEZONE);
    ...
    public void testRoundDownTimeStampHoursWithTimeZone() {
        ...
        long withTimeZone = TimestampRoundDownUtil.roundDownTimeStampHours(cal.getTimeInMillis(), 2, CUSTOM_TIMEZONE);
