...
public class TestSequenceGeneratorSource {
    ...
    public void testSingleEvents() throws EventDeliveryException {
        ...
        Mockito.doNothing()
                ...
                .doNothing()
                .when(cp)
                .processEvent(Mockito.any(Event.class));
    ...
    public void testBatch() throws EventDeliveryException {
        ...
        Mockito.doNothing()
                ...
                .doNothing()
                .when(cp)
                .processEventBatch(Mockito.anyList());
    ...
    private static void verifyEventSequence(int expectedTotalEvents, List<Event> actualEvents) {
        ...
        Assert.assertEquals("mismatching number of events", expectedTotalEvents, sortedFilteredEvents.size());
        for (int i = 0; i < sortedFilteredEvents.size(); ++i) {
            Assert.assertEquals("missing or unexpected event body", i, (int) sortedFilteredEvents.get(i));
        }
    }
