...
public class TestNetcatUdpSource {
    ...
    private final String mediumString =
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " + "Nunc maximus rhoncus viverra. Nunc a metus.";
    ...
    private void runUdpTest(String data1) throws IOException {
        ...
        datagramPacket = new DatagramPacket(
                data1.getBytes(), data1.getBytes().length, InetAddress.getLocalHost(), source.getSourcePort());
        for (int i = 0; i < 10; i++) {
