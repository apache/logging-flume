...
public class TestFlumeAuthenticator {
    ...
    public static void startMiniKdc() throws Exception {
        workDir = new File(System.getProperty("test.dir", "target"), TestFlumeAuthenticator.class.getSimpleName());
    ...
    public void testFlumeLogin() throws IOException {
        ...
        try {
            ...
            assertTrue(
                    "Login with a new principal failed, but for an unexpected " + "reason: " + ex.getMessage(),
    ...
    public void testFlumeLoginPrincipalWithoutRealm() throws Exception {
        ...
        FlumeAuthenticator authenticator =
                FlumeAuthenticationUtil.getAuthenticator(principal, keytab.getAbsolutePath());
        assertTrue(authenticator.isAuthenticated());
