...
image::DevGuide_image00.png[Agent component diagram]
...
Flume 1.11.0 contains a fix for https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-42468[CVE-2022-42468].
See the xref:security.adoc[Flume Security] page for more details.

The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-11-0[Flume 1.11.0 release notes].

This release can be downloaded from the Flume xref:download.adoc[Download] page.
...
please visit our xref:getinvolved.adoc[Get Involved] page.
...
The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-10-1[Flume 1.10.1 release notes].
...
Flume 1.10.0 contains a fix for https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-25167[CVE-2022-25167].
See the xref:security.adoc[Flume Security] page for more details.
...
The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-10-0[Flume 1.10.0 release notes].
...
The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-9-0[Flume 1.9.0 release notes].
...
The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-8-0[Flume 1.8.0 release notes].
...
The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-7-0[Flume 1.7.0 release notes].
...
The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-6-0[Flume 1.6.0 release notes].
...
The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-5-2[Flume 1.5.2 release notes].
...
The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-5-0-1[Flume 1.5.0.1 release notes].
...
The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-5-0[Flume 1.5.0 release notes].
...
The full change log and documentation are available on the
xref:release-notes.adoc#release-notes-1-4-0[Flume 1.4.0 release notes].
...
xref:release-notes.adoc#release-notes-1-3-1[Flume 1.3.1 release notes]
...
xref:release-notes.adoc#release-notes-1-3-0[Flume 1.3.0 release notes]
...
xref:release-notes.adoc#release-notes-1-2-0[Flume 1.2.0 release notes]

Your help and feedback is more than welcome!

=== July 26, 2012 - Flume Meetup NYC

Strata {plus} Hadoop World (http://strataconf.com/stratany2012) will be
...
In order to help with organization, a https://docs.google.com/spreadsheet/viewform?formkey=dGRDUUxxbUI3TUJuYnQwMV9sVzJDZEE6MA#gid=0[form]
has been set up with a few questions about what kind of Meetup the community wants, and which evening is best.
Please fill out the https://docs.google.com/spreadsheet/viewform?formkey=dGRDUUxxbUI3TUJuYnQwMV9sVzJDZEE6MA#gid=0[form].
