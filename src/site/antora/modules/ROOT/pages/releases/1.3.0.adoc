...
* link:content/1.3.0/FlumeUserGuide.pdf[Flume User Guide]
* link:content/1.3.0/FlumeDeveloperGuide.pdf[Flume Developer Guide]
* link:content/1.3.0/apidocs/index.html[API Documentation]
...
++**++ Improvement::
  ...
  * ++[++FLUME-1713++]++ - Netcat source should allow for _not_ returning "OK" upon receipt of each message.
...
++**++ Bug::
  ...
  * ++[++FLUME-1572++]++ - Add batching to FILE++_++ROLL sink
  * ++[++FLUME-1576++]++ - CHECKPOINT++_++INCOMPLETE should be synced to disk before starting the checkpoint.
  * ++[++FLUME-1577++]++ - CHECKPOINT++_++INCOMPLETE should be synced to disk before starting the checkpoint.
  * ++[++FLUME-1578++]++ - Proposal to modify file channel encryption config
  * ++[++FLUME-1582++]++ - flume-ng script should set LD++_++LIBRARY++_++PATH
