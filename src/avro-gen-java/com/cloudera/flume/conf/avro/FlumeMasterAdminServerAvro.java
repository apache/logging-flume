...
public interface FlumeMasterAdminServerAvro {
  ...
  long submit(com.cloudera.flume.conf.avro.FlumeMasterCommandAvro command) throws org.apache.avro.ipc.AvroRemoteException;
  boolean isSuccess(long cmdid) throws org.apache.avro.ipc.AvroRemoteException;
  boolean isFailure(long cmdid) throws org.apache.avro.ipc.AvroRemoteException;
  java.util.Map<java.lang.CharSequence,com.cloudera.flume.conf.avro.FlumeNodeStatusAvro> getNodeStatuses() throws org.apache.avro.ipc.AvroRemoteException;
  java.util.Map<java.lang.CharSequence,com.cloudera.flume.conf.avro.AvroFlumeConfigData> getConfigs() throws org.apache.avro.ipc.AvroRemoteException;
  java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> getMappings(java.lang.CharSequence physicalNode) throws org.apache.avro.ipc.AvroRemoteException;
  boolean hasCmdId(long cmdid) throws org.apache.avro.ipc.AvroRemoteException;
}
