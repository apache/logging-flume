...
public class ThriftFlumeEventServer {
  ...
  public static class Client implements org.apache.thrift.TServiceClient, Iface {
    ...
    {
      oprot_.writeMessageBegin(new org.apache.thrift.protocol.TMessage("rawAppend", org.apache.thrift.protocol.TMessageType.CALL, ++seqid_));
    ...
    {
      oprot_.writeMessageBegin(new org.apache.thrift.protocol.TMessage("ackedAppend", org.apache.thrift.protocol.TMessageType.CALL, ++seqid_));
    ...
    public EventStatus recv_ackedAppend() throws org.apache.thrift.TException
    {
      ...
      if (msg.seqid != seqid_) {
        throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.BAD_SEQUENCE_ID, "ackedAppend failed: out of sequence response");
      }
    ...
    private class rawAppend implements ProcessFunction {
      public void process(int seqid, org.apache.thrift.protocol.TProtocol iprot, org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException
      {
        ...
        try {
          ...
          iprot.readMessageEnd();
          org.apache.thrift.TApplicationException x = new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.PROTOCOL_ERROR, e.getMessage());
          oprot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("rawAppend", org.apache.thrift.protocol.TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
    ...
    private class ackedAppend implements ProcessFunction {
      public void process(int seqid, org.apache.thrift.protocol.TProtocol iprot, org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException
      {
        ...
        try {
          ...
          iprot.readMessageEnd();
          org.apache.thrift.TApplicationException x = new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.PROTOCOL_ERROR, e.getMessage());
          oprot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("ackedAppend", org.apache.thrift.protocol.TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
        ...
        oprot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("ackedAppend", org.apache.thrift.protocol.TMessageType.REPLY, seqid));
        result.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
      }
