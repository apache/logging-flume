...
public class TestFlumeSpecGen {
  ...
  /**
   * This tests to make sure that a let is parsed properly and then regenerated
   * by the spec generator.
   */
  @Test
  public void testLet() throws RecognitionException, FlumeSpecException {
  ...
  /**
   * This tests to make sure that a failover sink is parsed properly and then
   * regenerated by the spec generator.
   */
  @Test
  public void testFailchain() throws RecognitionException, FlumeSpecException {
