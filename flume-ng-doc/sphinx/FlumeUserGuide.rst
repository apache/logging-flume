...
allowTopicHeader                    true                 When set, the sink will allow a message to be produced into a topic specified by the ``topicHeader`` property (if provided).
topicHeader                         topic                When set in conjunction with ``allowTopicHeader`` will produce a message into the value of the header named using the value of this property.
