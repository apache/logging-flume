...
==========================  =========  =======================================================================================================================
**channels**                --
**type**                    --         The component type name, needs to be ``org.apache.flume.source.pubsub.CloudPubSubSource``
...
.. code-block:: properties
  ...
  a1.sources = r1
  a1.channels = c1
  a1.sources.r1.type = org.apache.flume.source.pubsub.CloudPubSubPullSource
