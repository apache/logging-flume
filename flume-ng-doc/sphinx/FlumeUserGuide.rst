...
+------------------------+-------------+------------+--------------+---------------+-------+--------+
|                        | AbstractRpc | AsyncHBase | BucketWriter | ElasticSearch | HBase | HBase2 |
+------------------------+-------------+------------+--------------+---------------+-------+--------+
...
| ChannelReadFail        | x           |            |              |               |       | x      |
+------------------------+-------------+------------+--------------+---------------+-------+--------+
| ConnectionClosedCount  | x           | x          | x            | x             | x     | x      |
+------------------------+-------------+------------+--------------+---------------+-------+--------+
| ConnectionCreatedCount | x           | x          | x            | x             | x     | x      |
+------------------------+-------------+------------+--------------+---------------+-------+--------+
| ConnectionFailedCount  | x           | x          | x            | x             | x     | x      |
+------------------------+-------------+------------+--------------+---------------+-------+--------+
| EventDrainAttemptCount | x           | x          | x            | x             | x     | x      |
+------------------------+-------------+------------+--------------+---------------+-------+--------+
...
+------------------------+-----------+------+------+-------+-----------+-------------+
| ConnectionClosedCount  |           | x    |      |       |           | x           |
+------------------------+-----------+------+------+-------+-----------+-------------+
| ConnectionCreatedCount |           | x    |      |       |           | x           |
+------------------------+-----------+------+------+-------+-----------+-------------+
| ConnectionFailedCount  |           | x    |      |       |           | x           |
+------------------------+-----------+------+------+-------+-----------+-------------+
