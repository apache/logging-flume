...
public class TestFlumeConfigurationConfigFilter {
    ...
    public void testFlumeConfigFilterWorks() {
        ...
        properties.put("agent1.configfilters.f1.type", "org.apache.flume.conf.configfilter.MockConfigFilter");
        properties.put("agent1.configfilters.f2.type", "org.apache.flume.conf.configfilter.MockConfigFilter");
