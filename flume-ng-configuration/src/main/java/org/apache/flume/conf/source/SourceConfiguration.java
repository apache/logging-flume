...
public class SourceConfiguration extends ComponentConfiguration {
    ...
    public void configure(Context context) throws ConfigurationException {
        ...
        try {
            ...
            if (channels.isEmpty()) {
                errors.add(new FlumeConfigurationError(
                        componentName,
            ...
            this.selectorConf = (ChannelSelectorConfiguration) ComponentConfigurationFactory.create(
                    ComponentType.CHANNELSELECTOR.getComponentType(), config, ComponentType.CHANNELSELECTOR);
        ...
        public SourceConfiguration getConfiguration(String name) throws ConfigurationException {
            ...
            try {
                if (srcConfigurationName != null) {
                    clazz = (Class<? extends SourceConfiguration>) Class.forName(srcConfigurationName);
