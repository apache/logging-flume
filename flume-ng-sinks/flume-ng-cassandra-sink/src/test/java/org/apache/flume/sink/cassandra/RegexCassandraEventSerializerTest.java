...
public class RegexCassandraEventSerializerTest {
  ...
  public void testGetActions() throws Exception {
    Map<String, Object> actions = serializer.getActions(("172.30.91.67 - - " +
        "[09/May/2017:02:55:58 +0000] \"GET /api?app_id=198&page=1&limit=20 " +
        "HTTP/1.1\" 200 94534 3").getBytes());
  ...
  public void testFailSerialization() {
    Map<String, Object> actions = serializer.getActions(("172.30.10.198 - - " +
        "[09/May/2017:00:59:15 +0000] \"POST /api/search HTTP/1.1\" 404 949 36").getBytes());
